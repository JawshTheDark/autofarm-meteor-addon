...
A small Meteor Client addon that automates basic crop farming and planting.
Includes two modules designed to work well in survival worlds and village farms.
...
- Requires a hoe **somewhere in your hotbar**.
### 🌱 AutoPlanter
...
2. Download the latest `autofarm-<version>.jar` from the Releases page.
...
3. Enable:
   - `Auto Farmer` to harvest and replant
   - `Auto Planter` to plant crops and/or feed composters
